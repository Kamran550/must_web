  ...
  const resources: LibraryResource[] = [
    {
      ...
      image: "/images/bodleian-libraries-tile.jpg",
    ...
    },
    {
      ...
      image: "/images/Huberlin-logo.svg.png",
      url: "https://www.ub.hu-berlin.de",
    },
    {
      id: "doaj",
      name: t("resources.doaj.name"),
      description: t("resources.doaj.description"),
      image: "/images/POL_Jagiellonian_University_logo.svg.png",
      url: "https://bj.uj.edu.pl",
    },
    {
      id: "eric",
      name: t("resources.eric.name"),
      description: t("resources.eric.description"),
      image: "/images/simbol_pos_rgb.jpg",
    ...
    },
    {
      ...
      image: "/images/sorbonne-university9280.jpg",
    ...
    },
    {
      ...
      image: "/images/Technical-University-of-Munich_thumb.png",
    ...
    },
    {
      ...
      image: "/images/UCL-logo-services-logo.jpg",
    ...
    },
    {
      ...
      image: "/images/WarsawUniversityofTechnologypng_1677580152.png",
      url: "https://eng.pw.edu.pl/Students-Life/Libraries/The-Main-Library",
    },
  ];
